...
export function Navbar({ onMenuClick, user = adminData }: NavbarProps) {
  ...
  return (
    <motion.nav
      className="fixed top-0 left-0 right-0 z-30 h-20 bg-white dark:bg-slate-900 border-b border-gray-200 dark:border-slate-700 shadow-sm transition-colors duration-200"
      initial={{ y: -100 }}
      animate={{ y: 0 }}
    ...
    >
      <div className="h-full px-4 lg:px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          {/* Logo/Brand */}
          <div className="text-xl font-bold text-gray-900 dark:text-white hidden sm:block">Admin Panel</div>
        </div>
        ...
        <div className="hidden md:flex flex-1 max-w-md mx-4">
          <div className="w-full relative">
            ...
            <input
              type="text"
              placeholder="Search..."
              className="w-full pl-10 pr-4 py-2 rounded-lg bg-gray-100 dark:bg-slate-800 text-gray-900 dark:text-white placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 border border-transparent focus:border-blue-500 dark:focus:border-blue-400"
            />
          </div>
        </div>
            ...
            <div className="absolute right-0 mt-2 w-80 bg-white dark:bg-slate-800 rounded-lg shadow-lg border border-gray-200 dark:border-slate-700 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 pt-0">
              ...
              <div className="max-h-64 overflow-y-auto">
                ...
                <div className="p-4 text-sm text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-slate-700 cursor-pointer transition-colors border-t border-gray-100 dark:border-slate-700">
                  <p className="font-medium text-gray-900 dark:text-white">Product Out of Stock</p>
                  <p className="text-xs mt-1">1 hour ago</p>
                </div>
                <div className="p-4 text-sm text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-slate-700 cursor-pointer transition-colors border-t border-gray-100 dark:border-slate-700">
                  <p className="font-medium text-gray-900 dark:text-white">New Customer Registered</p>
